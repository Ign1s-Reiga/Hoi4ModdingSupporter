      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-8 px-8 py-10">
        <header className="space-y-2">
          ...
          <p className="max-w-xl text-sm leading-relaxed text-muted">
            Open a mod descriptor to browse its files, edit national focus trees and keep
            localisation tidy. Everything is written straight back to the mod folder.
          </p>
        </header>
        ...
        <section className="space-y-3">
          <div className="flex items-baseline justify-between">
            ...
            {recents.length > 0 ? (
              <span className="text-xs text-muted">{recents.length} saved</span>
            ) : null}
          </div>
